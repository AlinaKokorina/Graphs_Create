...
set DEFAULT_JVM_OPTS="--module-path" "%APP_HOME%\lib" "--module" "com.example.graph/com.example.graph.GraphLauncher"
...
@rem Execute Graph
"%JAVA_EXE%" %JAVA_OPTS% %GRAPH_OPTS% %DEFAULT_JVM_OPTS% %*
...
if not ""=="%GRAPH_EXIT_CONSOLE%" exit %EXIT_CODE%
exit /b %EXIT_CODE%
